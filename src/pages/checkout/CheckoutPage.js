...
const ReviewOrderAction = ({ action }) => {
  return (
    <>
      ...
      <MobileMDContainer>
        <LargePrimaryButton className='cta-button bg-demoActionColor' title="CONFIRM AND PAY" onClick={action} />
      </MobileMDContainer>
    </>
  )
}
              ...
              (
                <div className='deferredPaymentBox'>
                  ...
                  {!payment.requiresInitialization && (<FilledButton
                    ...
                    className="mt-4 w-auto bg-demoActionColor text-eerieBlack"
                  >
                    PAY
                  </FilledButton>)}
                </div>
