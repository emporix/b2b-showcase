                                ...
                                <div className="md:flex justify-between">
                                    <div className="font-semibold text-[32px]">
                                        ...
                                        {order?.paymentDetails?.externalPaymentRedirectURL ?
                                            (<>Your Order has been created but we are waiting for payment to be
                                                completed.</>) :
                                    ...
                                    <div>
                                        {order?.paymentDetails?.externalPaymentRedirectURL ? (
                                            ...
                                            <button
                                                className="cta-button bg-primary px-6 py-0 h-[50px] text-[14px] leading-[14px] md:w-[400px] w-full">
                                                VIEW INVOICE
                                            </button>
                                        )}
                                    </div>
