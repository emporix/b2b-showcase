...
import {fetchQuoteDetails, fetchQuoteReasons, patchQuoteById, updateQuote,} from '../../services/quotes'
                    ...
                    <Field
                        ...
                        content={
                            <div className="text-sm">
                                ...
                                <div
                                    className="my-2">{`${quote.shippingAddress.addressLine1} ${quote.shippingAddress.addressLine2}`}</div>
                                <div
                                    className="my-2">{`${quote.shippingAddress.postcode} ${quote.shippingAddress.city}`}</div>
                    ...
                    <Field
                        ...
                        content={
                            <div className="text-sm">
                                ...
                                <div
                                    className="my-2">{`${quote.billingAddress.addressLine1} ${quote.billingAddress.addressLine2}`}</div>
                                <div
                                    className="my-2">{`${quote.billingAddress.postcode} ${quote.billingAddress.city}`}</div>
                    ...
                    <Grid xs={5} item className="p-4">
                        ...
                        <div className="mt-4">
                            <FilledButton
                                ...
                                className="mt-4 w-auto bg-primary text-eerieBlack"
                            >
                                ACCEPT QUOTE
                            </FilledButton>
                            <FilledButton
