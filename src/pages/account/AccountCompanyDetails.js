  ...
  return (
    <>
      <div className="w-full md:py-12 py-5 md:flex md:justify-between border-bottom-gray">
        <div className=" font-bold company-label label">
          Company Name
        </div>
      ...
      <div className="w-full md:pt-12 pt-6 md:flex md:justify-between">
        <div className=" font-bold company-label label border-bottom-gray md:border-0 pb-3 md:pb-3">
          Legal Entity
...
const AccountCompanyDetails = () => {
  ...
  return (
    <AccountLayout page="Company Details">
      <CompanyDetails value={user.company} />
    </AccountLayout>
  )
}
