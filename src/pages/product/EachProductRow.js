...
const EachProductRow = ({ item, type, available, rating, productCount }) => {
  ...
  return (
    <div className="standard_box_shadow h-full rounded-xl bg-aliceBlue p-4 flex gap-4">
      <div className="flex w-1/4 flex-col justify-between">
        <img
          src={imageSrc}
          alt=""
          className=" aspect-square h-fit rounded-xl cursor-pointer"
      ...
      <div className="flex flex-col w-1/2">
        ...
        <div className="flex flex-col gap-2">
          <div
            className="mt-4 h-fit text-left w-full text-2xl text-eerieBlack font-light cursor-pointer"
            onClick={handleProductDetail}
          >
