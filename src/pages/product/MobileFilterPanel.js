...
const MobileFilterPanel = (props) => {
    return (
        <div
            className="lg:hidden min-w-[375px] text-black fixed top-0 left-0 w-full  h-screen bg-white px-6 py-12  text-center font-medium overflow-y-auto z-50">
            ...
            <div className="mt-12 font-inter font-bold">
                <div className="w-full h-12 bg-primary text-eerieBlack  flex items-center cursor-pointer">
