      ...
      <GridLayout className="md:w-[540px] w-[95%] mx-auto h-[740px]">
        ...
        <GridLayout className="w-full bg-white p-12  rounded">
          <GridLayout className="text-center">
            <Heading2 className="text-eerieBlack text-[24px]/[32px] font-semibold">Register as a New User</Heading2>
          ...
          <form onSubmit={handleSignup} className="display: block m-0">
            <Box className="!pt-12 text-black text-base">
              ...
              <input
                ...
                className="border w-full px-3 py-2"
              />
              {!isValidEmail(userEmail) && <h6 style={{ color: 'red' }}>Email is invalid</h6>}
            </Box>
            ...
            <Box className="!pt-6 w-full text-black text-base">
              ...
              <input
                ...
                className="border w-full px-3 py-2"
              />
              {!firstName && <h6 style={{ color: 'red' }}>First Name must be provided</h6>}
            </Box>
            ...
            <Box className="!pt-6 w-full text-black text-base">
              ...
              <input
                ...
                className="border w-full px-3 py-2"
              />
              {!lastName && <h6 style={{ color: 'red' }}>Last Name must be provided</h6>}
            </Box>
            ...
            <Box className="!pt-6 w-full text-black text-base">
              ...
              <input
                ...
                className="border w-full px-3 py-2"
              />
              {company && !registrationId && <h6 style={{ color: 'red' }}>Registration Number must be provided</h6>}
            </Box>
            <Box className="!pt-6 w-full text-black text-base">
              <label className="pb-2">Phone Number</label>
              <PhoneField value={phoneNumber} onChange={(value) => setPhoneNumber(value)} />
            </Box>
            <br />
            <div className="mt-2 text-black">Shipping Address</div>
            {((company && !addressValid(shippingAddress)) || !addressEmptyValid(shippingAddress)) && (
              <h6 style={{ color: 'red' }}>Correct shipping address must be provided</h6>
            )}
            <AddressForm
