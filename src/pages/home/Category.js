...
const EachCategory = (props) => {
  return (
    <div>
      <div className="before:bg-demoActionColor before:w-[12px] before:h-[312px] before:absolute before:rounded-l-[4px]">
        <img src={props.src} alt="" className="w-[276px] h-[312px] object-cover rounded-l-[4px]"/>
      </div>
      <div className="pt-6  font-semibold text-[20px] leading-[32px]">
        {props.title}
      </div>
...
const Category = () => {
  return (
    <div className="home_category">
      <div className="desktop_only  font-bold text-2xl text-center">
        Explore our products
      </div>
      <div className="desktop_only md:pt-4  text-[18px]/[30px] font-normal text-center">
