...
const Subscribe = () => {
  return (
    <div className="subscribe">
      ...
      <button className="bg-lightBlue mt-6 md:mt-12  h-12 px-[98.5px] md:px-[55px] py-[17px] md:w-[240px] text-center border border-white font-bold font-inter text-[14px] leading-[14px]">
        SUBSCRIBE NOW
      </button>
    </div>
  )
