...
const ShippingMethod = ({ radioKey, shippingmode, price, onClick }) => {
  ...
  const { deliveryWindows } = useUserAddress()
    ...
    <>
        ...
        >
          <div className="flex justify-between w-full items-center">
            <div className="flex">
              ...
              <div className="pt-2 md:pt-0 pl-3 flex items-center">
      ...
      {getActualDeliveryWindows(deliveryWindows, currentSite).length > 0 && radioActive === radioKey && (
        <div className="pt-2 md:pt-0 pl-3" style={{ marginLeft: '50px' }}>
          <DeliveryWindow sitesDeliveryWindows={getActualDeliveryWindows(deliveryWindows, currentSite)} />
        </div>
      )}
    </>
  )
