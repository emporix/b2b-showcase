...
import {CurrencyBeforeValue, GridLayout, LayoutBetween,} from 'components/Utilities/common'
...
const CartRequestQuote = () => {
    return (
        <Link to={quoteUrl()} className="w-full">
            <button
                className="cart-request-quote-btn py-[12px] px-[14px] bg-transparent rounded text-eerieBlack border border-gray80">
                REQUEST QUOTE
            </button>
        </Link>
    )
...
const CartGoCart = () => {
    return (
        <Link to={cartUrl()} className="w-full">
            <button
                className="cart-go-cart-btn py-[12px] px-[14px] bg-transparent rounded text-eerieBlack border border-gray80">
                GO TO CART
            </button>
        </Link>
    )
        ...
        <div className="cart-action-panel">
            <GridLayout className="gap-4">
              ...
              <span className="font-semibold text-green-600">
                ...
                <CartActionRow>
                    <LayoutBetween>
                        <CartShipingCost currency={cartAccount.currency}
