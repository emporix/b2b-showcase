...
export const ShoppableVideo = (props) => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const availabilityMap = new Map(Object.values(availabilityData).map((item) => [item.productId, item]))
  ...
  return (
    <div className="video-container flex-col">
      ...
      {isOverlayVisible && (
        <div className={`product-container ${isOverlayVisible ? 'visible' : 'invisible'} mx-width: max-xl:`}>
