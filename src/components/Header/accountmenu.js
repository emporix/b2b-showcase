  ...
  return (
    <div ref={menuRef} className="relative inline-block text-left">
      ...
      <div
        ...
        } origin-top-right absolute bg-g right-0 w-56 rounded-md shadow-lg bg-white ring-black ring-opacity-5 focus:outline-none transition-opacity duration-600`}
      >
        <div className="py-1">
          <NavLink
