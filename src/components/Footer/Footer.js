...
const MobileFooter = ({ blok }) => {
  return (
    <div className="mobile_only_flex flex-col">
      <div className="flex flex-col p-6 bg-demoGrayBrightest">
...
const DesktopFooter = ({ blok }) => {
  return blok && (
    <div className="desktop_only_flex flex-col">
      <div className="bg-demoGrayBrightest">
        <div
      ...
      <div className="max-w-screen-xl mx-auto prose-p:text-xs p-6 xl:px-0 prose-p:text-demoGrayDarkest">
        <FormattedTextBox text={blok.legalInformation} />
      </div>
    </div>
  )
